...
exports.ResponseWriter = exports.cancelCORS = void 0;
const consts_1 = require("../config/consts");
const defaultHeaders = {
    'Access-Control-Allow-Credentials': 'true',
    'Access-Control-Allow-Headers': 'Content-Type,Authorization,X-Requested-With',
    'Access-Control-Allow-Methods': 'GET,POST,PUT,DELETE,OPTIONS',
    'Access-Control-Allow-Origin': consts_1.FRONT,
...
const status = (statusCode, headers = undefined) => {
    return (body = undefined, headersOverride = undefined) => {
        console[((statusCode < 300 || consts_1.isTest) && 'log') || (statusCode < 400 && 'warn') || 'error'](`[${statusCode}]`, 'headers:', headers, 'headersOverride:', headersOverride, 'body:', body);
        return {
            statusCode,
