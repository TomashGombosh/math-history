...
const handler = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (Number.isNaN(yearNum)) {
        return response_writer_1.ResponseWriter.BadRequest({ message: 'Invalid year' });
    }
    const data = yield (0, graduate_service_1.getGraduateYearDetail)(yearNum);
    return response_writer_1.ResponseWriter.Success(data);
});
