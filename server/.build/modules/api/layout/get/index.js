...
const handler = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const cfg = yield (0, layout_service_1.getLayoutConfig)();
        return response_writer_1.ResponseWriter.Success(cfg);
    }
    catch (e) {
        (0, lambda_log_1.logException)('layout:get_failed', e, ctx.correlationIds);
        return response_writer_1.ResponseWriter.InternalServerError({ message: 'Cannot read layout config' });
    }
});
